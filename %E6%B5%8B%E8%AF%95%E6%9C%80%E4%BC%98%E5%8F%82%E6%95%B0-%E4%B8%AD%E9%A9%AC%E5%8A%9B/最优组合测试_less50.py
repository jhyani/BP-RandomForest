...
#             print(error_out[each])    
    ...
    writer = pd.ExcelWriter('output_new_less_50.xls',engine='xlsxwriter')
    start_row = 1
    for i in range(25):
...
if __name__ == '__main__':
    if os.path.exists('./error_record_less_50.txt'):
        os.remove('error_record_less_50.txt')
    log = open('error_record_less_50.txt', 'a+')
    main1()
