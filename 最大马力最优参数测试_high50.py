...
#                 rec.flush()
    ...
    writer = pd.ExcelWriter('大马力_最优参数_high_50.xls',engine='xlsxwriter')
    start_row = 1
    for i in range(25):
...
if __name__ == '__main__':
    if os.path.exists('./大马力最优参数_high_50.txt'):
        os.remove('大马力最优参数_high_50.txt')

    log = open('大马力最优参数_high_50.txt', 'a+')
#     rec = open('data_record_high_50.txt', 'a+')
    main1()
